...
const MarketChatbot: React.FC<MarketChatbotProps> = ({
  marketInsights,
  theme = "dark",
}) => {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0 && marketInsights) {
      setMessages([
        {
          role: "assistant",
          content: `Hi! 👋 I'm your market analysis assistant. I have access to your market research data and I'm here to help you understand it better. Feel free to ask me anything about:

• Feasibility scores and market potential
          ...
          >
            <form onSubmit={handleSubmit} className="flex gap-2">
              <input
                ...
                placeholder="Ask about your market research..."
                disabled={isLoading}
